...
contract RuleBlacklistOwnable2Step is RuleBlacklistBase, Ownable2Step, Ownable2StepERC165Module {
    ...
    /**
     * @notice Deploys the rule and sets the initial owner and meta-transaction forwarder.
    ...
    /**
     * @notice Restricts adding addresses to the blacklist to the contract owner.
     */
    function _authorizeAddressListAdd() internal view virtual override onlyOwner {}

    /**
     * @notice Restricts removing addresses from the blacklist to the contract owner.
     */
