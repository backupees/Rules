...
- The root README's ASCII topology block is replaced by a rendered PlantUML diagram with its source in [`doc/schema/`](./doc/schema/), alongside a new ERC-3643 section covering both pluggable slots (compliance and identity registry) and the direction each contract faces.
